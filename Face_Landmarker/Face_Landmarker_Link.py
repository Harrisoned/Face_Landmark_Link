...
with open(output_csv_path, 'w', newline='') as csv_file:
    ...
    while cap.isOpened():
        ...
        with FaceLandmarker.create_from_options(options) as landmarker:
            ...
            new_order = [8, 10, 12, 14, 16, 18, 20, 9, 11, 13, 15, 17, 19, 21, 22, 25, 23, 24, 26, 31, 37, 38, 32, 43, 44, 29, 30, 27, 28, 45, 46, 39, 40, 41, 42, 35, 36, 33, 34, 47, 48, 49, 1, 2, 3, 4, 5, 6, 7, 49, 50]
